...
sealed abstract class AbstractVectorSplitter implements PartitionedSplitter
    permits VectorCsvSplitter, VectorFwSplitter {

    private final PartitionStreamer streamer;

    private final Partition partition;

    protected AbstractVectorSplitter(PartitionStreamer streamer) {
